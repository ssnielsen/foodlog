...
// Remove serving and update meal table
$(function() {
...
var pie_data = [['Fat',14], ['Protein',31], ['Carbo',55]];
  ...
  series: {
    pie: {
      ...
      label: {
        show: true,
        radius: 1/2,
        formatter: function(label, series) { return series.percent + "%"; },
        background: {
          opacity: 0,
        },
        threshold: 0.1
...
console.log(data);
    // Update piechart
    // var macro_sum = data.protein + data.carbo + data.fat;
    console.log(pie_data);
    pie_data = [['Fat',Math.round(data.fat,2)], ['Protein',Math.round(data.protein,2)], ['Carbo',Math.round(data.carbo,2)]];
    console.log(pie_data);
